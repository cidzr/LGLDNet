...
def Normalize(in_channels):
    num_groups = 32 if in_channels % 32 == 0 else 16
...
class CrossAttention(nn.Module):
    ...
    def forward(self, x, context=None, mask=None):
        ...
        if context.ndim == 3:  # context includes k and v from condition
            k = self.to_k(context)
            v = self.to_v(context)
        elif context.ndim == 4:
            ...
            raise ValueError(f'Unsupported context dim: {context.ndim}')
